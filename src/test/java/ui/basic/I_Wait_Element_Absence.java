...
public class I_Wait_Element_Absence {
    WebDriver driver;
    WebDriverWait wait;
    ...
    public void testA() {
        ...
        wait.until(ExpectedConditions.and(
                ...
                ExpectedConditions.visibilityOf(driver.findElement(iPhone))
        ));
        wait.until(ExpectedConditions.elementToBeClickable(searchEl));
        if( driver.findElements(popup).size() > 0 ) {
            driver.findElement(popupClose).click();
        }
        searchEl.sendKeys("meizu");
        searchEl.sendKeys(Keys.ENTER);
        ...
        //wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(searchResultItem)));
        wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//span[contains(text(), 'iPhone')]")));
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(), 'meizu')]")));
